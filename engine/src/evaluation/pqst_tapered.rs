...
use super::piece::{ENDGAME_PIECE_POINTS, OPENING_PIECE_POINTS, STATIC_PIECE_POINTS};

type PQST = [i32; 64];

const fn flip_psqt(mut table: PQST) -> [i32; 64] {
    let mut i = 0;
    while i < 64 / 2 {
...
const fn add_value(mut table: PQST, value: i32) -> [i32; 64] {
    let mut i = 0;
    while i < 64 {
        table[i] += value;
        i += 1;
...
const EMPTY_TABLE: PQST = [0; 64];

#[rustfmt::skip]
const ENDGAME_PAWN_TABLE: PQST = add_value(flip_psqt([
    0,   0,   0,   0,   0,   0,  0,   0,
...
#[rustfmt::skip]
const OPENING_PAWN_TABLE: PQST = add_value(flip_psqt([
    0,   0,   0,   0,   0,   0,   0,   0,
...
#[rustfmt::skip]
const ENDGAME_KNIGHT_TABLE: PQST = add_value(flip_psqt([
...
#[rustfmt::skip]
const OPENING_KNIGHT_TABLE: PQST = add_value(flip_psqt([
...
#[rustfmt::skip]
const ENDGAME_BISHOP_TABLE: PQST = add_value(flip_psqt([
...
#[rustfmt::skip]
const OPENING_BISHOP_TABLE: PQST = add_value(flip_psqt([
...
#[rustfmt::skip]
const ENDGAME_ROOK_TABLE: PQST = add_value(flip_psqt([
...
#[rustfmt::skip]
const OPENING_ROOK_TABLE: PQST = add_value(flip_psqt([
...
#[rustfmt::skip]
const ENDGAME_QUEEN_TABLE: PQST = add_value(flip_psqt([
...
#[rustfmt::skip]
const OPENING_QUEEN_TABLE: PQST = add_value(flip_psqt([
...
#[rustfmt::skip]
const ENDGAME_KING_TABLE: PQST = add_value(flip_psqt([
...
#[rustfmt::skip]
const OPENING_KING_TABLE: PQST = add_value(flip_psqt([
...
const OPENING_PQST_TABLES: [PQST; 7] = [
    EMPTY_TABLE,
    OPENING_PAWN_TABLE,
...
const ENDGAME_PQST_TABLES: [PQST; 7] = [
    EMPTY_TABLE,
    ENDGAME_PAWN_TABLE,
...
const PHASE_INCREMENT_BY_PIECE: [i32; 7] = [0, 0, 1, 1, 2, 4, 0];
...
pub fn eval(game: &GameState) -> i32 {
    ...
    while occupied != 0 {
        ...
        opening += OPENING_PQST_TABLES[piece][pos];
        endgame += ENDGAME_PQST_TABLES[piece][pos];
        // } else {
        opening -= OPENING_PQST_TABLES[piece][pos ^ 56];
        endgame -= ENDGAME_PQST_TABLES[piece][pos ^ 56];
        // }
    }
